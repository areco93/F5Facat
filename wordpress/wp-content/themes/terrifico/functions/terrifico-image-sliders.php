...
<div class="flexslider da-slider" >
	...
	<?php while ( $flex_query->have_posts() ): $flex_query->the_post(); ?>
		<li>
			...
			<?php } else { ?>
				<?php if ($slider_cat !='') { ?>
					<img class="attachment-full wp-post-image rs-slide-image" width="1024" height="500" alt="slide" src="<?php echo get_template_directory_uri() ?>/images/assets/image02.jpg">
				<?php } else { ?>
